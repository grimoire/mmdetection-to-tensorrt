...
@tensorrt_converter("mmdet2trt.core.bbox.coder.delta_xywh_bbox_coder.delta2bbox_custom_func")
def convert_delta2bbox(ctx):
    ...
    plugin = create_delta2bbox_custom_plugin("delta2bbox_custom_" + str(id(cls_scores)),
